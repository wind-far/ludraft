---
name: Unity Test Framework 使用
description: "测试领域技能包：Unity Test Framework的EditMode/PlayMode测试、NUnit特性、AAA模式、AC关联命名。适用于需要编写或执行自动化测试时。"
allowed-tools:
  - read_file
  - search_content
  - search_file
...
- MonoBehaviour 生命周期最佳实践 (`monobehaviour-patterns`)
- 空安全最佳实践 (`null-safety`)
